...
const SCOPE_REDIRECT = (section: AssistantSection) =>
  `Si el usuario pregunta sobre algo que no corresponde a la sección de "${SECTION_NAMES[section]}", responde brevemente: "Esa pregunta corresponde a la sección de [nombre correcto de la sección], donde podrás resolverla mejor." y ofrece una breve orientación. No profundices en temas de otras secciones.`;
