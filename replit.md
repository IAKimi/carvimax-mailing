...
- **IA / Imágenes**: Gemini API (modelo gemini-2.0-flash-exp con responseModalities IMAGE)
...
- Gemini: usa modelo gemini-2.0-flash-exp con responseModalities ["IMAGE", "TEXT"]
