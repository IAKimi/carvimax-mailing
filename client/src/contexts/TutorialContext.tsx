...
const BRAND_STEPS: TutorialStep[] = [
  ...
  { fieldId: "history", label: "Sobre la Empresa", description: "Opcional: cuente un poco más sobre su empresa (trayectoria, a quién se dirige, diferenciadores u otro contexto útil)." },
